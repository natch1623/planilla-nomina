...
export default defineConfig(({ mode }) => {
  ...
  return {
    // GitHub Pages sirve el sitio bajo /<repo>/, así que los assets necesitan
    // ese prefijo. BASE_PATH lo fija en el workflow de despliegue y deja
    // intacto el flujo de Figma Make, que usa su propia variable.
